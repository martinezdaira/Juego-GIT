...
<p>CRUD es una forma básica de manejar datos en un sistema. Se usa en casi cualquier aplicación que guarda información, como redes sociales o tiendas online.</p>
 ...
 <p>-Create agrega datos nuevos.
    -Read obtiene datos existentes.
 ...
 <h1>Por qué es importante un CRUD en una aplicación?</h1>
    ...
    *Tienda en línea:
    ...
    <br>
    <h1>CRUD-Natalia</h1>
    <h1>lenguaje de programacion CRUD</h1>
    <p> CRUD no es un lenguaje de programacion en si mismo sino un acronimo que representa las cuatro operaciones basicas que se pueden realizar en una base de datos o sistena de gestion de datos. Estas operaciones son fudamentales para el manejo y manipulacion de datos en aplicaciones informaticas.</p>
    <h1> Importancia de CRUD en el desarrollo de software</h1>
    <p> CRUD es importante en el desarrolo de software porque proporciona un marco estandarizado para interactuar con los datos en una aplicacion. facilita la cracion, lectura, actualizacion y eliminar datos de manera eficiente y consistente. al seguir el modelo CRUD, los desarrolladores puedemn crear aplicaciones mas organizadas y mantenibles</p>
</br>
</body>
</html>